...
var range2=null
  ...
  const [selected_delivery_status, setselected_delivery_status] = useState(0);
...
setshowPro(0)
  ...
  const getData = async () => {
   ...
   await axios.post(base_url + "stock_counts", {...abc, created_branch_id:checked, i_priority_id_3:pro_prio, sender_client_id_7:services_clients_id,i_product_type_id:i_product_type_id }).then((res) => {
    ...
    const getData2 = async (selected_delivery_status=null) => {
            ...
            <ContentBox>
              ...
              <Box ml="12px">
                ...
                <IconButton onClick={() => {     
                 ...
                 <Icon data-id={item.id} onClick={handlecountsShow} >attach_money</Icon>
              </IconButton>                
                 </Small>
